...
var parkhaus_1 = require("./parkhaus");
var rndKennzeichen_1 = require("./rndKennzeichen");
var myprompt = require("prompt-sync")();
var parkhaus1 = new parkhaus_1.Parkhaus("Qpark", 5);
var tempCar;
var carArray = new Array(rndKennzeichen_1.kennzeichenArray.length);
...
function getTimeFormat(zeit) {
    ...
    fahrtZeit = new Date("".concat(today.getFullYear(), "-").concat(today.getMonth(), "-").concat(today.getDate(), " ").concat(zeit, ":00"));
    return fahrtZeit;
}
